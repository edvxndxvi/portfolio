...
export const Experiences = () => {
  ...
  const experiences = [
    {
      id: 1,
      role: t("blueshift.role"),
      period: t("blueshift.period"),
      companyLogo: blueshift,
      companyName: "Blueshift",
    },
    {
      id: 2,
      role: t("bradesco.role"),
      period: t("bradesco.period"),
      companyLogo: bradesco,
      companyName: "Bradesco",
    },
    {
      id: 3,
      role: t("gigroup.role"),
      period: t("gigroup.period"),
      companyLogo: gigroup,
      companyName: "Gi Group",
    },
  ];
