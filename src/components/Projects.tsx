  ...
  const projects = [
    {
      ...
      name: "TapDano",
      desc: t("tapdano"),
      tecnologys: ["React", "TypeScript"],
      links: ["https://github.com/tapdano/tapdano/", "https://tapdano.com/"],
    },
    {
      id: 2,
      image: wattwise,
      name: "WattWise",
      desc: t("wattwise"),
      tecnologys: ["NextJs", "TypeScript", "Tailwind CSS"],
      links: [
        "https://github.com/edvxndxvi/wattwise",
        "https://wattwise-delta.vercel.app/visaoGeral",
      ],
    },
    {
      id: 3,
      ...
      links: [
        "https://github.com/edvxndxvi/bikehub",
        "https://edvxndxvi.github.io/bikehub/",
      ],
    },
  ];
