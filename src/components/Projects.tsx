...
import ratings from '../../public/images/ratings.jpg';
...
export const Projects = () => {
    ...
    const projects = [
        ...
        {id: 3, image: ratings, name: 'Ratings', desc: t('ratings'), tecnologys: ['React', 'SCSS', 'TypeScript'], links: ['https://github.com/edvxndxvi/ratings-FIAP','https://ratingscp1-aavdmyf20-edvxndxvis-projects.vercel.app/']},
    ];
