    ...
    <>
      ...
      <main className="max-w-[1440px] mx-auto">
        <section className="px-4 max-w-[1440px] relative mx-auto overflow-hidden lg:overflow-visible">
          ...
          <div className="pt-36 min-[600px]:pt-72 grid place-items-center gap-20 text-center">
            ...
            <div className="grid gap-7">
              <h2 className="text-2xl font-medium bg-gradient-to-r from-text to-gradient-end inline-block text-transparent bg-clip-text">{t('experienceWith')}</h2>
              <div className="grid">
              <Tecnology/>
              </div>
            </div>
        ...
        <section id="projects" className="py-32 md:py-64 px-4">
          <h2 className="text-text-gray text-4xl font-medium text-center mb-20">{lastestProjects?.[0]}<span className="text-text">{lastestProjects?.[1]}</span></h2>
          <Projects/>
        </section>
        ...
        <section id="about" className="pb-32 md:pb-64 px-4 grid gap-28 lg:gap-16">
          {/* Overview */}
          <div>
            <h2 className="text-text-gray font-medium text-4xl text-center max-w-[600px] mx-auto">{aboutTitle?.[0]}<span className="text-text">{aboutTitle?.[1]}</span>{aboutTitle?.[2]}<span className="text-text">UX/UI design</span></h2>
            <p className="text-text-gray text-center max-w-[1000px] mx-auto text-lg my-10">{t('aboutText')}</p>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-24 lg:gap-10">
            <div className="grid gap-10">
              <h3 className="font-medium text-4xl bg-gradient-to-r from-text to-gradient-end inline-block text-transparent bg-clip-text">{t('experiencesTitle')}</h3>
              <Experiences/>
            </div>

            <div className="grid gap-10">
              <h3 className="font-medium text-4xl bg-gradient-to-r from-text to-gradient-end inline-block text-transparent bg-clip-text">{t('formationsAndMerits')}</h3>
              <Educations/>
            </div>
          </div>
        ...
        <section id='contact' className="pb-5 px-4 max-w-[1440px] relative mx-auto overflow-hidden">
          ...
          <div className="grid gap-32">
            <div className="max-w-[790px] mx-auto text-center grid gap-8">
              <h2 className="font-medium text-5xl">{t('contactTitle')}</h2>
              <p className="text-text-gray text-xl">{t('contactText')}</p>
