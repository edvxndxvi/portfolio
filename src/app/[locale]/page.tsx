    ...
    <>
      ...
      <main className="max-w-[1440px] mx-auto overflow-hidden lg:overflow-visible">
        ...
        <section id="projects" className="py-32 md:py-64 px-4">
          ...
          >
            {lastestProjects?.[0]}
            <span className="text-text">{lastestProjects?.[1]}</span>
          </motion.h2>
          <Projects />
        </section>
        ...
        <section
          id="about"
          className="pb-16 md:pb-64 px-4 grid gap-28 lg:gap-16"
        >
          {/* Overview */}
          <div>
            <motion.h2
            ...
            >
              {aboutTitle?.[0]}
              <span className="text-text">{aboutTitle?.[1]}</span>
              {aboutTitle?.[2]}
              <span className="text-text">UX/UI design</span>
            </motion.h2>
            <motion.p
            ...
            <div className="flex sm:flex-row flex-col gap-12 sm:gap-24 justify-center">
              ...
              >
                <p className="text-6xl text-text font-medium relative">
                  <span className="absolute text-4xl font-semibold -top-2 -left-6">
                    +
                  </span>
                  3
                </p>
                <span className="inline-block text-text-gray font-medium">
                  {t("yearsExperience")}
                </span>
              </motion.div>
              <motion.div
        ...
        <section
          id="contact"
          className="pt-16 pb-5 px-4 max-w-[1440px] relative mx-auto overflow-hidden"
        >
          {/* Spotlight Effect Elements */}
          ...
          <div className="grid gap-32">
            ...
            <footer className="flex justify-between flex-col-reverse min-[520px]:flex-row items-center gap-5">
              ...
              <div className="flex gap-5">
                <a href="https://github.com/edvxndxvi" target="_blank">
                  <FontAwesomeIcon icon={faGithub} className="navbar-icon" />
                </a>
                <a
                  href="https://www.linkedin.com/in/edvan-davi-119970236/"
                  target="_blank"
                >
